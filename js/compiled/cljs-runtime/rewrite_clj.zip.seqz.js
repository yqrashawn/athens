...
var G__50277 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__50277__$1 = (((G__50277 == null))?null:cljs.core.iterate((function (loc){
...
var G__50277__$2 = (((G__50277__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50277__$1));
var G__50277__$3 = (((G__50277__$2 == null))?null:cljs.core.last(G__50277__$2));
if((G__50277__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__50277__$3);
}
} else {
return zloc;
}
...
var G__50280 = rewrite_clj.zip.move.right(v);
var G__50281 = rewrite_clj.zip.move.up(v);
loc = G__50280;
parent = G__50281;
continue;
} else {
var G__50282 = rewrite_clj.zip.move.right(v0);
var G__50283 = parent;
loc = G__50282;
parent = G__50283;
continue;
...
var G__50284 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__50285 = rewrite_clj.zip.move.up(v);
loc = G__50284;
parent = G__50285;
continue;
} else {
var G__50286 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__50287 = parent;
loc = G__50286;
parent = G__50287;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__50278 = zloc;
var G__50278__$1 = (((G__50278 == null))?null:rewrite_clj.zip.move.down(G__50278));
var G__50278__$2 = (((G__50278__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__50278__$1,k));
if((G__50278__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__50278__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__50279 = rewrite_clj.zip.move.down(zloc);
var G__50279__$1 = (((G__50279 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__50279));
if((G__50279__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50279__$1);
}
})(),k);
}
});
