...
var G__49874 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__49874__$1 = (((G__49874 == null))?null:cljs.core.iterate((function (loc){
...
var G__49874__$2 = (((G__49874__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__49874__$1));
var G__49874__$3 = (((G__49874__$2 == null))?null:cljs.core.last(G__49874__$2));
if((G__49874__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__49874__$3);
}
} else {
return zloc;
}
...
var G__49911 = rewrite_clj.zip.move.right(v);
var G__49912 = rewrite_clj.zip.move.up(v);
loc = G__49911;
parent = G__49912;
continue;
} else {
var G__49913 = rewrite_clj.zip.move.right(v0);
var G__49914 = parent;
loc = G__49913;
parent = G__49914;
continue;
...
var G__49915 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__49916 = rewrite_clj.zip.move.up(v);
loc = G__49915;
parent = G__49916;
continue;
} else {
var G__49917 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__49918 = parent;
loc = G__49917;
parent = G__49918;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__49890 = zloc;
var G__49890__$1 = (((G__49890 == null))?null:rewrite_clj.zip.move.down(G__49890));
var G__49890__$2 = (((G__49890__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__49890__$1,k));
if((G__49890__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__49890__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__49891 = rewrite_clj.zip.move.down(zloc);
var G__49891__$1 = (((G__49891 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__49891));
if((G__49891__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__49891__$1);
}
})(),k);
}
});
