 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__45550){
var vec__45551 = p__45550;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45551,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45551,(1),null);
return (function (s){
...
var len__4789__auto___45573 = arguments.length;
var i__4790__auto___45574 = (0);
while(true){
if((i__4790__auto___45574 < len__4789__auto___45573)){
args__4795__auto__.push((arguments[i__4790__auto___45574]));

var G__45575 = (i__4790__auto___45574 + (1));
i__4790__auto___45574 = G__45575;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__45554_SHARP_){
return (p1__45554_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__45554_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__45554_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq45556){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45556));
}));
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45564__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45564__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45564__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__45587 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__45588 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45567 = tag;
var G__45567__$1 = (((G__45567 instanceof cljs.core.Keyword))?G__45567.fqn:null);
switch (G__45567__$1) {
case "string":
return chunk;
