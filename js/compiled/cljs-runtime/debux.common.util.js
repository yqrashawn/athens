...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__68889_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__68889_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68888_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__68888_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__68890_SHARP_){
return (((p1__68890_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__68890_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__68894,mapping){
var map__68895 = p__68894;
var map__68895__$1 = (((((!((map__68895 == null))))?(((((map__68895.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68895.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68895):map__68895);
var state = map__68895__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68895__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68895__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68895__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__68892_SHARP_){
if((p1__68892_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__68892_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__68952 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__68954 = clojure.zip.next(loc);
loc = G__68954;
continue;
}
}
...
var len__4789__auto___68997 = arguments.length;
var i__4790__auto___68998 = (0);
while(true){
if((i__4790__auto___68998 < len__4789__auto___68997)){
args__4795__auto__.push((arguments[i__4790__auto___68998]));

var G__68999 = (i__4790__auto___68998 + (1));
i__4790__auto___68998 = G__68999;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__68905){
var vec__68906 = p__68905;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68906,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq68903){
var G__68904 = cljs.core.first(seq68903);
var seq68903__$1 = cljs.core.next(seq68903);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68904,seq68903__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__68909_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__68909_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__68911_69001 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__68912_69002 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__68913_69003 = true;
var _STAR_print_fn_STAR__temp_val__68914_69004 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__68913_69003);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__68914_69004);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__68912_69002);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__68911_69001);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__68910_SHARP_){
return debux.common.util.prepend_bars(p1__68910_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__69008 = cljs.core.next(opts__$1);
var G__69009 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__69008;
acc = G__69009;
continue;
} else {
if(typeof f === 'string'){
var G__69010 = cljs.core.next(opts__$1);
var G__69011 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__69010;
acc = G__69011;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__69012 = cljs.core.nnext(opts__$1);
var G__69013 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__69012;
acc = G__69013;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__69014 = cljs.core.next(opts__$1);
var G__69015 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__69014;
acc = G__69015;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__68917 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__68917.cljs$core$IFn$_invoke$arity$1 ? fexpr__68917.cljs$core$IFn$_invoke$arity$1(f) : fexpr__68917.call(null,f));
})())){
var G__69018 = cljs.core.next(opts__$1);
var G__69019 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__69018;
acc = G__69019;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__68918 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__68918.cljs$core$IFn$_invoke$arity$1 ? fexpr__68918.cljs$core$IFn$_invoke$arity$1(f) : fexpr__68918.call(null,f));
})())){
var G__69020 = cljs.core.nnext(opts__$1);
var G__69021 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__69020;
acc = G__69021;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__69023 = cljs.core.next(opts__$1);
var G__69024 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__69023;
acc = G__69024;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__68919){
var vec__68920 = p__68919;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68920,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68920,(1),null);
...
var G__68925 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__68924 = (function (){var fexpr__68926 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__68926.cljs$core$IFn$_invoke$arity$1 ? fexpr__68926.cljs$core$IFn$_invoke$arity$1(form) : fexpr__68926.call(null,form));
})();
return (fexpr__68924.cljs$core$IFn$_invoke$arity$1 ? fexpr__68924.cljs$core$IFn$_invoke$arity$1(G__68925) : fexpr__68924.call(null,G__68925));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__68928 = quoted_form;
var G__68929 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__68928,G__68929) : debux.common.util.remove_d.call(null,G__68928,G__68929));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__68930 = quoted_form;
var G__68931 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__68930,G__68931) : debux.common.util.remove_d.call(null,G__68930,G__68931));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__69036__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__68932 = quoted_form;
var G__68933 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__68932,G__68933) : debux.common.util.remove_d.call(null,G__68932,G__68933));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__69037__i < G__69037__a.length) {G__69037__a[G__69037__i] = arguments[G__69037__i + 0]; ++G__69037__i;}
  arg = new cljs.core.IndexedSeq(G__69037__a,0,null);
} 
return G__69036__delegate.call(this,arg);};
G__69036.cljs$lang$maxFixedArity = 0;
G__69036.cljs$lang$applyTo = (function (arglist__69038){
var arg = cljs.core.seq(arglist__69038);
return G__69036__delegate(arg);
});
...
var G__69040 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__69040;
continue;
} else {
...
var G__69046 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__69046;
continue;
} else {
var G__69047 = clojure.zip.next(loc);
loc = G__69047;
continue;
