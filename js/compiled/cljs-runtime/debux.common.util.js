...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__70604_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__70604_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__70603_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__70603_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__70605_SHARP_){
return (((p1__70605_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__70605_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__70652,mapping){
var map__70655 = p__70652;
...
var state = map__70655__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70655__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70655__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70655__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__70640_SHARP_){
if((p1__70640_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__70640_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__70779 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__70780 = clojure.zip.next(loc);
loc = G__70780;
continue;
}
}
...
var len__4789__auto___70814 = arguments.length;
var i__4790__auto___70815 = (0);
while(true){
if((i__4790__auto___70815 < len__4789__auto___70814)){
args__4795__auto__.push((arguments[i__4790__auto___70815]));

var G__70820 = (i__4790__auto___70815 + (1));
i__4790__auto___70815 = G__70820;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__70704){
var vec__70705 = p__70704;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70705,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq70698){
var G__70699 = cljs.core.first(seq70698);
var seq70698__$1 = cljs.core.next(seq70698);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70699,seq70698__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__70708_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__70708_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__70715_70821 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__70716_70822 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__70717_70823 = true;
var _STAR_print_fn_STAR__temp_val__70718_70824 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__70717_70823);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__70718_70824);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__70716_70822);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__70715_70821);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__70709_SHARP_){
return debux.common.util.prepend_bars(p1__70709_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__70827 = cljs.core.next(opts__$1);
var G__70828 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__70827;
acc = G__70828;
continue;
} else {
if(typeof f === 'string'){
var G__70833 = cljs.core.next(opts__$1);
var G__70834 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__70833;
acc = G__70834;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__70835 = cljs.core.nnext(opts__$1);
var G__70836 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__70835;
acc = G__70836;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__70837 = cljs.core.next(opts__$1);
var G__70838 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__70837;
acc = G__70838;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__70741 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__70741.cljs$core$IFn$_invoke$arity$1 ? fexpr__70741.cljs$core$IFn$_invoke$arity$1(f) : fexpr__70741.call(null,f));
})())){
var G__70839 = cljs.core.next(opts__$1);
var G__70840 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__70839;
acc = G__70840;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__70742 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__70742.cljs$core$IFn$_invoke$arity$1 ? fexpr__70742.cljs$core$IFn$_invoke$arity$1(f) : fexpr__70742.call(null,f));
})())){
var G__70841 = cljs.core.nnext(opts__$1);
var G__70842 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__70841;
acc = G__70842;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__70843 = cljs.core.next(opts__$1);
var G__70844 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__70843;
acc = G__70844;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__70744){
var vec__70745 = p__70744;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70745,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70745,(1),null);
...
var G__70750 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__70749 = (function (){var fexpr__70751 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__70751.cljs$core$IFn$_invoke$arity$1 ? fexpr__70751.cljs$core$IFn$_invoke$arity$1(form) : fexpr__70751.call(null,form));
})();
return (fexpr__70749.cljs$core$IFn$_invoke$arity$1 ? fexpr__70749.cljs$core$IFn$_invoke$arity$1(G__70750) : fexpr__70749.call(null,G__70750));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__70754 = quoted_form;
var G__70755 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__70754,G__70755) : debux.common.util.remove_d.call(null,G__70754,G__70755));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__70756 = quoted_form;
var G__70757 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__70756,G__70757) : debux.common.util.remove_d.call(null,G__70756,G__70757));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__70854__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__70761 = quoted_form;
var G__70762 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__70761,G__70762) : debux.common.util.remove_d.call(null,G__70761,G__70762));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__70856__i = 0, G__70856__a = new Array(arguments.length -  0);
while (G__70856__i < G__70856__a.length) {G__70856__a[G__70856__i] = arguments[G__70856__i + 0]; ++G__70856__i;}
  arg = new cljs.core.IndexedSeq(G__70856__a,0,null);
} 
return G__70854__delegate.call(this,arg);};
G__70854.cljs$lang$maxFixedArity = 0;
G__70854.cljs$lang$applyTo = (function (arglist__70857){
var arg = cljs.core.seq(arglist__70857);
return G__70854__delegate(arg);
});
...
var G__70861 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__70861;
continue;
} else {
...
var G__70862 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__70862;
continue;
} else {
var G__70863 = clojure.zip.next(loc);
loc = G__70863;
continue;
