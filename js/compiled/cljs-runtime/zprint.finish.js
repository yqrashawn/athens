...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48314_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48314_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48314_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48316){
var vec__48318 = p__48316;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48318,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48318,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48326,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48327__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48327__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48327__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48334 = (function (){var or__4185__auto__ = color;
...
var fexpr__48333 = (function (){var G__48335 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48335) : style_map.call(null,G__48335));
})();
return (fexpr__48333.cljs$core$IFn$_invoke$arity$1 ? fexpr__48333.cljs$core$IFn$_invoke$arity$1(G__48334) : fexpr__48333.call(null,G__48334));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48338){
var vec__48340 = p__48338;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48340,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48340,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48340,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48344){
var vec__48345 = p__48344;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48345,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48345,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48345,(2),null);
...
var G__48488 = cljs.core.next(ssv);
var G__48489 = (this_ssv == null);
var G__48490 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__48491 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__48488;
doing_nil_QMARK_ = G__48489;
last_elide = G__48490;
out = G__48491;
continue;
}
...
var vec__48358 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48358,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48358,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48358,(2),null);
...
var G__48495 = cljs.core.next(remaining_cvec);
var G__48496 = new_idx;
var G__48497 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48495;
idx = G__48496;
out = G__48497;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48391,cursor_vec){
var vec__48392 = p__48391;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48392,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48392,(1),null);
var focus_vec = vec__48392;
...
var vec__48396 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48396,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48396,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48405){
var vec__48407 = p__48405;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48407,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48407,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48420,existing_count){
var vec__48421 = p__48420;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48421,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48421,(1),null);
...
return cljs.core.filterv((function (p1__48414_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48414_SHARP_))));
...
var vec__48441 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48441,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48441,(1),null);
var cvec_element = vec__48441;
if((cvec_element == null)){
var G__48534 = cljs.core.next(cvec_nl);
var G__48535 = (idx + (1));
var G__48536 = start;
var G__48537 = out;
cvec_nl = G__48534;
...
var G__48538 = cljs.core.next(cvec_nl);
var G__48539 = (idx + (1));
var G__48540 = idx;
var G__48541 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48538;
idx = G__48539;
start = G__48540;
out = G__48541;
...
var G__48542 = cljs.core.next(cvec_nl);
var G__48543 = (idx + (1));
var G__48544 = (idx + (1));
var G__48545 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48542;
idx = G__48543;
start = G__48544;
out = G__48545;
...
var G__48547 = cljs.core.next(cvec_nl);
var G__48548 = (idx + (1));
var G__48549 = idx;
...
var G__48551 = cljs.core.next(cvec_nl);
var G__48552 = (idx + (1));
var G__48553 = start;
var G__48554 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__48551;
idx = G__48552;
start = G__48553;
out = G__48554;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48445_SHARP_,p2__48444_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48444_SHARP_)){
return cljs.core.reduced(p1__48445_SHARP_);
} else {
return (p1__48445_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48450,p__48451){
var vec__48452 = p__48450;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48452,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48452,(1),null);
var vec__48455 = p__48451;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48455,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48455,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__48461,cvec,focus_vec){
...
var options = map__48462__$1;
var map__48463 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48462__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48463__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48463__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48463__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48460_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__48460_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
