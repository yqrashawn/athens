...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48394_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48394_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48394_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48395){
var vec__48396 = p__48395;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48396,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48396,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48399,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48400__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48400__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48400__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48404 = (function (){var or__4185__auto__ = color;
...
var fexpr__48403 = (function (){var G__48405 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48405) : style_map.call(null,G__48405));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48413){
var vec__48414 = p__48413;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48414,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48414,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48414,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48417){
var vec__48418 = p__48417;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48418,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48418,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48418,(2),null);
...
var G__48486 = cljs.core.next(ssv);
var G__48487 = (this_ssv == null);
var G__48488 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
...
var vec__48425 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48425,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48425,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48425,(2),null);
...
var G__48490 = cljs.core.next(remaining_cvec);
var G__48491 = new_idx;
var G__48492 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48490;
idx = G__48491;
out = G__48492;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48433,cursor_vec){
var vec__48434 = p__48433;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48434,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48434,(1),null);
var focus_vec = vec__48434;
...
var vec__48437 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48437,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48437,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48441){
var vec__48442 = p__48441;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48442,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48442,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48452,existing_count){
var vec__48453 = p__48452;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48453,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48453,(1),null);
...
return cljs.core.filterv((function (p1__48445_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48445_SHARP_))));
...
var vec__48462 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48462,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48462,(1),null);
var cvec_element = vec__48462;
if((cvec_element == null)){
var G__48505 = cljs.core.next(cvec_nl);
var G__48506 = (idx + (1));
var G__48507 = start;
var G__48508 = out;
cvec_nl = G__48505;
...
var G__48509 = cljs.core.next(cvec_nl);
var G__48510 = (idx + (1));
var G__48511 = idx;
var G__48512 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48509;
idx = G__48510;
start = G__48511;
out = G__48512;
...
var G__48513 = cljs.core.next(cvec_nl);
var G__48514 = (idx + (1));
var G__48515 = (idx + (1));
var G__48516 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48513;
idx = G__48514;
start = G__48515;
out = G__48516;
...
var G__48518 = cljs.core.next(cvec_nl);
var G__48519 = (idx + (1));
var G__48520 = idx;
var G__48521 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__48518;
idx = G__48519;
start = G__48520;
out = G__48521;
...
var G__48522 = cljs.core.next(cvec_nl);
var G__48523 = (idx + (1));
var G__48524 = start;
var G__48525 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__48522;
idx = G__48523;
start = G__48524;
out = G__48525;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48467_SHARP_,p2__48466_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48466_SHARP_)){
return cljs.core.reduced(p1__48467_SHARP_);
} else {
return (p1__48467_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48469,p__48470){
var vec__48471 = p__48469;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48471,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48471,(1),null);
var vec__48474 = p__48470;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48474,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48474,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__48479,cvec,focus_vec){
var map__48480 = p__48479;
...
var options = map__48480__$1;
var map__48481 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48480__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48481__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48481__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48481__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48478_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__48478_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
