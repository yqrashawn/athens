...
var G__66444 = cljs.core.first(poshdb);
var G__66444__$1 = (((G__66444 instanceof cljs.core.Keyword))?G__66444.fqn:null);
switch (G__66444__$1) {
case "db":
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66444__$1)].join('')));
...
var G__66470 = cljs.core.cons(pdb,path);
var G__66471 = posh.lib.db.get_parent_db(pdb);
path = G__66470;
pdb = G__66471;
continue;
} else {
...
var G__66472 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__66472;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66452__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66452__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66452__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66452__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__66454 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__66454.cljs$core$IFn$_invoke$arity$1 ? fexpr__66454.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__66454.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__66455 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__66455.cljs$core$IFn$_invoke$arity$2 ? fexpr__66455.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__66455.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__66456 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__66456.cljs$core$IFn$_invoke$arity$2 ? fexpr__66456.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__66456.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__66457 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__66457.cljs$core$IFn$_invoke$arity$2 ? fexpr__66457.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__66457.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__66459 = db__$4;
var G__66460 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__66458 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__66458.cljs$core$IFn$_invoke$arity$2 ? fexpr__66458.cljs$core$IFn$_invoke$arity$2(G__66459,G__66460) : fexpr__66458.call(null,G__66459,G__66460));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__66461,poshdb){
...
var posh_tree = map__66462__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66462__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66462__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__66465 = (function (){var G__66467 = posh_tree;
var G__66468 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__66467,G__66468) : posh.lib.db.poshdb__GT_db.call(null,G__66467,G__66468));
})();
var G__66466 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__66464 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__66464.cljs$core$IFn$_invoke$arity$2 ? fexpr__66464.cljs$core$IFn$_invoke$arity$2(G__66465,G__66466) : fexpr__66464.call(null,G__66465,G__66466));
}
});
