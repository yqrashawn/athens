...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62989__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62989__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__62996 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__62996__$1 = (((G__62996 == null))?null:cljs.core.persistent_BANG_(G__62996));
if((G__62996__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__62996__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__63003){
...
var frame = first__63006;
var frames = seq__63005__$1;
...
var results = (function (){var G__63009 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__63009,kvps);
} else {
return G__63009;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63011__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63011__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_63113 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_63113,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__63025){
var vec__63026 = p__63025;
var seq__63027 = cljs.core.seq(vec__63026);
var first__63028 = cljs.core.first(seq__63027);
var seq__63027__$1 = cljs.core.next(seq__63027);
var parent = first__63028;
var frames = seq__63027__$1;
...
var found = cljs.core.not_empty((function (){var G__63029 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__63029);
} else {
return G__63029;
}
})());
...
var as_value = (function (){var G__63038 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__63019_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__63019_SHARP_]);
}),G__63038);
} else {
return G__63038;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__63039 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__63039);
} else {
return G__63039;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__63040 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__63040,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__63040;
}
})());
...
var vec__63046 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63046,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63046,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__63049){
var vec__63050 = p__63049;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63050,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63050,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__63054){
...
var frame = first__63057;
var frames = seq__63056__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__63061){
var vec__63062 = p__63061;
var seq__63063 = cljs.core.seq(vec__63062);
var first__63064 = cljs.core.first(seq__63063);
var seq__63063__$1 = cljs.core.next(seq__63063);
var frame = first__63064;
var frames = seq__63063__$1;
...
var vec__63065 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63065,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63065,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63068__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63068__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__63070 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__63070,attr,eid);
} else {
return G__63070;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63071__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63071__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__63079){
while(true){
var vec__63082 = p__63079;
...
var frame = first__63084;
var frames = seq__63083__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__63139 = db;
var G__63140 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__63139;
p__63079 = G__63140;
continue;
}
...
while(true){
var G__63087 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__63087__$1 = (((G__63087 instanceof cljs.core.Keyword))?G__63087.fqn:null);
switch (G__63087__$1) {
case "expand":
var G__63142 = db;
var G__63143 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__63142;
frames = G__63143;
continue;
...
case "expand-rev":
var G__63144 = db;
var G__63145 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__63144;
frames = G__63145;
continue;
...
case "pattern":
var G__63146 = db;
var G__63147 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__63146;
frames = G__63147;
continue;
...
case "recursion":
var G__63148 = db;
var G__63149 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__63148;
frames = G__63149;
continue;
...
var f = first__63094;
var remaining = seq__63093__$1;
var result = (function (){var G__63095 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__63095);
} else {
return G__63095;
}
})();
...
var G__63150 = db;
var G__63151 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__63096 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__63096,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__63096;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63087__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__63097_SHARP_){
return datascript.db.entid_strict(db,p1__63097_SHARP_);
})),eids);
