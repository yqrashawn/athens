...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65263__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65263__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__65268 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__65268__$1 = (((G__65268 == null))?null:cljs.core.persistent_BANG_(G__65268));
if((G__65268__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__65268__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__65277){
var vec__65279 = p__65277;
var seq__65280 = cljs.core.seq(vec__65279);
var first__65281 = cljs.core.first(seq__65280);
var seq__65280__$1 = cljs.core.next(seq__65280);
var frame = first__65281;
var frames = seq__65280__$1;
...
var results = (function (){var G__65288 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__65288,kvps);
} else {
return G__65288;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65297__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65297__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_65384 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_65384,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__65314){
var vec__65315 = p__65314;
var seq__65316 = cljs.core.seq(vec__65315);
var first__65317 = cljs.core.first(seq__65316);
var seq__65316__$1 = cljs.core.next(seq__65316);
var parent = first__65317;
var frames = seq__65316__$1;
...
var found = cljs.core.not_empty((function (){var G__65319 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__65319);
} else {
return G__65319;
}
})());
...
var as_value = (function (){var G__65323 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__65310_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__65310_SHARP_]);
}),G__65323);
} else {
return G__65323;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__65325 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__65325);
} else {
return G__65325;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__65327 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__65327,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__65327;
}
})());
...
var vec__65328 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65328,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65328,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__65331){
var vec__65332 = p__65331;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65332,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65332,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__65335){
var vec__65336 = p__65335;
var seq__65337 = cljs.core.seq(vec__65336);
var first__65338 = cljs.core.first(seq__65337);
var seq__65337__$1 = cljs.core.next(seq__65337);
var frame = first__65338;
var frames = seq__65337__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__65339){
var vec__65340 = p__65339;
var seq__65341 = cljs.core.seq(vec__65340);
var first__65342 = cljs.core.first(seq__65341);
var seq__65341__$1 = cljs.core.next(seq__65341);
var frame = first__65342;
var frames = seq__65341__$1;
...
var vec__65343 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65343,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65343,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65347__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65347__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__65349 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__65349,attr,eid);
} else {
return G__65349;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65351__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65351__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__65354){
while(true){
var vec__65355 = p__65354;
var seq__65356 = cljs.core.seq(vec__65355);
var first__65357 = cljs.core.first(seq__65356);
var seq__65356__$1 = cljs.core.next(seq__65356);
var frame = first__65357;
var frames = seq__65356__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__65439 = db;
var G__65440 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__65439;
p__65354 = G__65440;
continue;
}
...
while(true){
var G__65358 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__65358__$1 = (((G__65358 instanceof cljs.core.Keyword))?G__65358.fqn:null);
switch (G__65358__$1) {
case "expand":
var G__65453 = db;
var G__65454 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__65453;
frames = G__65454;
continue;
...
case "expand-rev":
var G__65455 = db;
var G__65456 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__65455;
frames = G__65456;
continue;
...
case "pattern":
var G__65457 = db;
var G__65458 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__65457;
frames = G__65458;
continue;
...
case "recursion":
var G__65459 = db;
var G__65460 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__65459;
frames = G__65460;
continue;
...
break;
case "done":
var vec__65359 = frames;
var seq__65360 = cljs.core.seq(vec__65359);
var first__65361 = cljs.core.first(seq__65360);
var seq__65360__$1 = cljs.core.next(seq__65360);
var f = first__65361;
var remaining = seq__65360__$1;
var result = (function (){var G__65362 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__65362);
} else {
return G__65362;
}
})();
...
var G__65461 = db;
var G__65462 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__65364 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__65364,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__65364;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65358__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__65365_SHARP_){
return datascript.db.entid_strict(db,p1__65365_SHARP_);
})),eids);
