...
var G__41248 = devtools.prefs.pref(v);
v = G__41248;
continue;
} else {
return v;
...
}catch (e41172){var _e__40491__auto__ = e41172;
return false;
}})();
...
}catch (e41177){var _e__40491__auto__ = e41177;
return false;
}})();
...
}catch (e41179){var _e__40491__auto__ = e41179;
return false;
}}
}
});
...
var vec__41195 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__41207_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41207_SHARP_);
}),template);
});
