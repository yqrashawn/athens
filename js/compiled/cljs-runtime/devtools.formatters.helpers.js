...
var G__42903 = devtools.prefs.pref(v);
v = G__42903;
continue;
} else {
return v;
...
}catch (e42869){var _e__40279__auto__ = e42869;
return false;
}})();
...
}catch (e42873){var _e__40279__auto__ = e42873;
return false;
}})();
...
}catch (e42875){var _e__40279__auto__ = e42875;
return false;
}}
}
});
...
var vec__42884 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42884,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42884,(1),null);
...
return cljs.core.some((function (p1__42889_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42889_SHARP_);
}),template);
});
