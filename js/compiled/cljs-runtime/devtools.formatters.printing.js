...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41255){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41273_SHARP_){
return (!((cljs.core.meta(p1__41273_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41293__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41300){var _e__40491__auto__ = e41300;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e41302){var _e__40491__auto__ = e41302;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41308 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41310 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41310);

try{var map__41311 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41311__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41308);
}});
...
var temp__5733__auto___41333 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___41333)){
var managed_print_level_41334 = temp__5733__auto___41333;
var _STAR_print_level_STAR__orig_val__41314_41335 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41315_41336 = managed_print_level_41334;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41315_41336);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41313_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41313_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41314_41335);
}} else {
job_fn();
}
