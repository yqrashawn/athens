...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k68943,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__68947 = k68943;
var G__68947__$1 = (((G__68947 instanceof cljs.core.Keyword))?G__68947.fqn:null);
switch (G__68947__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68943,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__68948){
var vec__68949 = p__68948;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68949,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68949,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__68942){
var self__ = this;
var G__68942__$1 = this;
return (new cljs.core.RecordIter((0),G__68942__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__68953 = (function (coll__4436__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__68953(this__4435__auto____$1);
})();
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68944,other68945){
var self__ = this;
var this68944__$1 = this;
return (((!((other68945 == null)))) && ((this68944__$1.constructor === other68945.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68944__$1.status,other68945.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68944__$1.body,other68945.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68944__$1.status_text,other68945.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68944__$1.headers,other68945.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68944__$1.was_aborted,other68945.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68944__$1.__extmap,other68945.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__68942){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__68978 = cljs.core.keyword_identical_QMARK_;
var expr__68979 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__68985 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__68986 = expr__68979;
return (pred__68978.cljs$core$IFn$_invoke$arity$2 ? pred__68978.cljs$core$IFn$_invoke$arity$2(G__68985,G__68986) : pred__68978.call(null,G__68985,G__68986));
})())){
return (new ajax.protocols.Response(G__68942,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68987 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__68988 = expr__68979;
return (pred__68978.cljs$core$IFn$_invoke$arity$2 ? pred__68978.cljs$core$IFn$_invoke$arity$2(G__68987,G__68988) : pred__68978.call(null,G__68987,G__68988));
})())){
return (new ajax.protocols.Response(self__.status,G__68942,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68989 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__68990 = expr__68979;
return (pred__68978.cljs$core$IFn$_invoke$arity$2 ? pred__68978.cljs$core$IFn$_invoke$arity$2(G__68989,G__68990) : pred__68978.call(null,G__68989,G__68990));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__68942,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68991 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__68992 = expr__68979;
return (pred__68978.cljs$core$IFn$_invoke$arity$2 ? pred__68978.cljs$core$IFn$_invoke$arity$2(G__68991,G__68992) : pred__68978.call(null,G__68991,G__68992));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__68942,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68993 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__68994 = expr__68979;
return (pred__68978.cljs$core$IFn$_invoke$arity$2 ? pred__68978.cljs$core$IFn$_invoke$arity$2(G__68993,G__68994) : pred__68978.call(null,G__68993,G__68994));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__68942,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__68942),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__68942){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__68942,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__68946){
var extmap__4478__auto__ = (function (){var G__69022 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68946,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__68946)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__69022);
} else {
return G__69022;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__68946),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__68946),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__68946),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__68946),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__68946),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
