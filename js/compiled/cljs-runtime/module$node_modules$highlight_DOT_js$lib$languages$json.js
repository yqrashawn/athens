...
hljs={begin:"\\[",end:"\\]",contains:[hljs.inherit(VALUE_CONTAINER)],illegal:"\\S"};TYPES.splice(TYPES.length,0,OBJECT,hljs);return{contains:TYPES,keywords:LITERALS,illegal:"\\S"}}}
