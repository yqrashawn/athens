...
var G__50257 = (function (){var G__50258 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__50258) : f.call(null,G__50258));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__50257) : rewrite_clj.node.coerce.call(null,G__50257));
});
/**
...
var len__4789__auto___50270 = arguments.length;
var i__4790__auto___50271 = (0);
while(true){
if((i__4790__auto___50271 < len__4789__auto___50270)){
args__4795__auto__.push((arguments[i__4790__auto___50271]));

var G__50272 = (i__4790__auto___50271 + (1));
i__4790__auto___50271 = G__50272;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__50259_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__50259_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq50260){
var G__50261 = cljs.core.first(seq50260);
var seq50260__$1 = cljs.core.next(seq50260);
var G__50262 = cljs.core.first(seq50260__$1);
var seq50260__$2 = cljs.core.next(seq50260__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50261,G__50262,seq50260__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50263 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50263) : str_fn.call(null,G__50263));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50264 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50264) : str_fn.call(null,G__50264));
})()):null)));
...
var G__50267 = rewrite_clj.zip.base.tag(zloc);
var G__50267__$1 = (((G__50267 instanceof cljs.core.Keyword))?G__50267.fqn:null);
switch (G__50267__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50265_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50265_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__50266_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50266_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50267__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__50269 = rewrite_clj.zip.base.tag(zloc);
var G__50269__$1 = (((G__50269 instanceof cljs.core.Keyword))?G__50269.fqn:null);
switch (G__50269__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50268_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50268_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50269__$1)].join('')));
