...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__68718 = (function (){var G__68719 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__68719) : parser.call(null,G__68719));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__68718) : tag_set.call(null,G__68718));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__68722){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68723__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68723__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__68735,hidden_QMARK_){
var map__68736 = p__68735;
var map__68736__$1 = (((((!((map__68736 == null))))?(((((map__68736.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68736.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68736):map__68736);
var p = map__68736__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68736__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68736__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68736__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68736__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68736__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__68741 = tag;
var G__68741__$1 = (((G__68741 instanceof cljs.core.Keyword))?G__68741.fqn:null);
switch (G__68741__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__68744_68809 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__68745_68810 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__68746_68811 = true;
var _STAR_print_fn_STAR__temp_val__68747_68812 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__68746_68811);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__68747_68812);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__68745_68810);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__68744_68809);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__68748_68813 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__68749_68814 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__68750_68815 = true;
var _STAR_print_fn_STAR__temp_val__68751_68816 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__68750_68815);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__68751_68816);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__68749_68814);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__68748_68813);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68741__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__68752){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68753__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68753__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__68756(s__68757){
return (new cljs.core.LazySeq(null,(function (){
var s__68757__$1 = s__68757;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68757__$1);
if(temp__5735__auto__){
var s__68757__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68757__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68757__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68759 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68758 = (0);
while(true){
if((i__68758 < size__4581__auto__)){
var vec__68769 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68758);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68769,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68769,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__68759,instaparse.print.rule__GT_str(non_terminal,parser));

var G__68826 = (i__68758 + (1));
i__68758 = G__68826;
continue;
} else {
var G__68827 = (i__68758 + (1));
i__68758 = G__68827;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68759),instaparse$print$Parser__GT_str_$_iter__68756(cljs.core.chunk_rest(s__68757__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68759),null);
}
} else {
var vec__68778 = cljs.core.first(s__68757__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68778,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68778,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__68756(cljs.core.rest(s__68757__$2)));
} else {
var G__68828 = cljs.core.rest(s__68757__$2);
s__68757__$1 = G__68828;
continue;
}
}
} else {
