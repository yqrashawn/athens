...
return [(function (){var pred__51766 = cljs.core.instance_QMARK_;
var expr__51767 = reactive_val;
if(cljs.core.truth_((pred__51766.cljs$core$IFn$_invoke$arity$2 ? pred__51766.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__51767) : pred__51766.call(null,reagent.ratom.RAtom,expr__51767)))){
return "ra";
} else {
if(cljs.core.truth_((pred__51766.cljs$core$IFn$_invoke$arity$2 ? pred__51766.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__51767) : pred__51766.call(null,reagent.ratom.RCursor,expr__51767)))){
return "rc";
} else {
if(cljs.core.truth_((pred__51766.cljs$core$IFn$_invoke$arity$2 ? pred__51766.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__51767) : pred__51766.call(null,reagent.ratom.Reaction,expr__51767)))){
return "rx";
} else {
if(cljs.core.truth_((pred__51766.cljs$core$IFn$_invoke$arity$2 ? pred__51766.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__51767) : pred__51766.call(null,reagent.ratom.Track,expr__51767)))){
return "tr";
} else {
return "other";
}
