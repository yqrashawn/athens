...
var vec__74365 = cljs.core.rest(expr);
var seq__74366 = cljs.core.seq(vec__74365);
var first__74367 = cljs.core.first(seq__74366);
var seq__74366__$1 = cljs.core.next(seq__74366);
var vec__74368 = first__74367;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74368,(0),null);
var form = seq__74366__$1;
...
var G__74371 = x;
var G__74371__$1 = (((G__74371 == null))?null:spec_tools.impl.polish(G__74371));
var G__74371__$2 = (((G__74371__$1 == null))?null:cljs.core.name(G__74371__$1));
if((G__74371__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__74371__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__74374 = x;
var G__74374__$1 = (((G__74374 == null))?null:cljs.core.name(G__74374));
if((G__74374__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__74374__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__74375){
...
var data = map__74376__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74376__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74376__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74376__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74376__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__74379){
var map__74380 = p__74379;
var map__74380__$1 = (((((!((map__74380 == null))))?(((((map__74380.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__74380.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__74380):map__74380);
var data = map__74380__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74380__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74380__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__74382 = data;
var G__74382__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__74382,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__74382);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__74382__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__74382__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__74387 = form;
var G__74387__$1 = (((G__74387 == null))?null:cljs.core.rest(G__74387));
if((G__74387__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__74387__$1);
}
})();
var G__74388 = m;
var G__74388__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__74388,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__74384_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__74384_SHARP_)));
})):G__74388);
var G__74388__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__74388__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__74385_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__74385_SHARP_)));
})):G__74388__$1);
var G__74388__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__74388__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__74386_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__74386_SHARP_));
})):G__74388__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__74388__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__74390 = (function (){var G__74391 = form;
var G__74391__$1 = (((G__74391 == null))?null:cljs.core.rest(G__74391));
if((G__74391__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__74391__$1);
}
})();
var map__74390__$1 = (((((!((map__74390 == null))))?(((((map__74390.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__74390.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__74390):map__74390);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74390__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74390__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74390__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74390__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__74393 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__74393) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__74400 = form;
var G__74400__$1 = (((G__74400 == null))?null:cljs.core.seq(G__74400));
var G__74400__$2 = (((G__74400__$1 == null))?null:cljs.core.first(G__74400__$1));
if((G__74400__$2 == null)){
return null;
} else {
var fexpr__74401 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__74401.cljs$core$IFn$_invoke$arity$1 ? fexpr__74401.cljs$core$IFn$_invoke$arity$1(G__74400__$2) : fexpr__74401.call(null,G__74400__$2));
}
})():null));
});
/**
...
var len__4789__auto___74448 = arguments.length;
var i__4790__auto___74449 = (0);
while(true){
if((i__4790__auto___74449 < len__4789__auto___74448)){
args__4795__auto__.push((arguments[i__4790__auto___74449]));

var G__74450 = (i__4790__auto___74449 + (1));
i__4790__auto___74449 = G__74450;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq74402){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq74402));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__74403){
var vec__74404 = p__74403;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74404,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74404,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__74420){
var map__74421 = p__74420;
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74421__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74421__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74421__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74421__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__74418_SHARP_){
return cljs.core.map_QMARK_(p1__74418_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__74419_SHARP_){
return cljs.core.contains_QMARK_(p1__74419_SHARP_,x);
});
}),req_keys));
