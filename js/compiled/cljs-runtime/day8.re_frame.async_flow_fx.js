 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__70388){
...
var G__70393 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__70394 = now_seen_events;
var fexpr__70392 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__70392.cljs$core$IFn$_invoke$arity$2 ? fexpr__70392.cljs$core$IFn$_invoke$arity$2(G__70393,G__70394) : fexpr__70392.call(null,G__70393,G__70394));
...
var G__70395 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__70396 = "async-flow: got bad value for :when - ";
var G__70397 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__70395,G__70396,G__70397) : re_frame.core.console.call(null,G__70395,G__70396,G__70397));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__70398){
var map__70399 = p__70398;
...
var rule = map__70399__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70399__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70399__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70399__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70399__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70399__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70399__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70399__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__70401 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__70402 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__70403 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__70401,G__70402,G__70403) : re_frame.core.console.call(null,G__70401,G__70402,G__70403));
} else {
var G__70404 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__70404__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70404,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__70404);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70404__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__70404__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70405__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70405__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__70407 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__70408 = "async-flow: dispatch-fn must return a seq of events ";
var G__70409 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__70407,G__70408,G__70409) : re_frame.core.console.call(null,G__70407,G__70408,G__70409));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__70410){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70411__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70411__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70411__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70411__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__70422,p__70423){
var map__70426 = p__70422;
var map__70426__$1 = (((((!((map__70426 == null))))?(((((map__70426.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70426.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70426):map__70426);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70426__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__70427 = p__70423;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70427,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70427,(1),null);
var event_v = vec__70427;
var pred__70431 = cljs.core._EQ_;
var expr__70432 = event_type;
if(cljs.core.truth_((function (){var G__70434 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__70435 = expr__70432;
return (pred__70431.cljs$core$IFn$_invoke$arity$2 ? pred__70431.cljs$core$IFn$_invoke$arity$2(G__70434,G__70435) : pred__70431.call(null,G__70434,G__70435));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__70436 = db;
var G__70437 = cljs.core.PersistentHashSet.EMPTY;
var G__70438 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__70436,G__70437,G__70438) : set_state.call(null,G__70436,G__70437,G__70438));
...
var vec__70439 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70439,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70439,(1),null);
var map__70442 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70442__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70442__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__70444 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70444,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70444,(1),null);
...
var G__70447 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__70447) : re_frame.core.dispatch.call(null,G__70447));
});
var G__70448_70488 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__70449_70489 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__70448_70488,G__70449_70489) : re_frame.core.reg_fx.call(null,G__70448_70488,G__70449_70489));
