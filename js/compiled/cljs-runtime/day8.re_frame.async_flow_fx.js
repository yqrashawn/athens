 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__46847){
...
var G__46852 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__46853 = now_seen_events;
var fexpr__46851 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__46851.cljs$core$IFn$_invoke$arity$2 ? fexpr__46851.cljs$core$IFn$_invoke$arity$2(G__46852,G__46853) : fexpr__46851.call(null,G__46852,G__46853));
...
var G__46854 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__46855 = "async-flow: got bad value for :when - ";
var G__46856 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__46854,G__46855,G__46856) : re_frame.core.console.call(null,G__46854,G__46855,G__46856));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__46863){
...
var rule = map__46864__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46864__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46864__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46864__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46864__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46864__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46864__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46864__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__46872 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__46873 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__46874 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__46872,G__46873,G__46874) : re_frame.core.console.call(null,G__46872,G__46873,G__46874));
} else {
var G__46875 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__46875__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46875,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__46875);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46875__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__46875__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46890__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46890__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__46899 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__46900 = "async-flow: dispatch-fn must return a seq of events ";
var G__46901 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__46899,G__46900,G__46901) : re_frame.core.console.call(null,G__46899,G__46900,G__46901));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__46908){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46909__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46909__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46909__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46909__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__46923,p__46924){
var map__46927 = p__46923;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46927__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__46928 = p__46924;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46928,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46928,(1),null);
var event_v = vec__46928;
var pred__46934 = cljs.core._EQ_;
var expr__46935 = event_type;
if(cljs.core.truth_((function (){var G__46945 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__46946 = expr__46935;
return (pred__46934.cljs$core$IFn$_invoke$arity$2 ? pred__46934.cljs$core$IFn$_invoke$arity$2(G__46945,G__46946) : pred__46934.call(null,G__46945,G__46946));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__46948 = db;
var G__46949 = cljs.core.PersistentHashSet.EMPTY;
var G__46950 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__46948,G__46949,G__46950) : set_state.call(null,G__46948,G__46949,G__46950));
...
var vec__46958 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46958,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46958,(1),null);
var map__46961 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46961__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46961__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__46985 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46985,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46985,(1),null);
...
var G__47047 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
...
var G__47079_47200 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__47080_47201 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__47079_47200,G__47080_47201) : re_frame.core.reg_fx.call(null,G__47079_47200,G__47080_47201));
